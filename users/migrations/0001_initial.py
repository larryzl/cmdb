    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uuid', models.CharField(default=uuid.UUID('7b7dd109-2a2d-3e0c-9bb2-fd8db8eeafd6'), max_length=64, unique=True)),
        ...
        migrations.AddField(
            ...
            name='department',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='users', to='users.department_Mode', verbose_name='部门'),
        ),
        migrations.AddField(
            model_name='customuser',
            name='groups',
